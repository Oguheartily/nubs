    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body table-responsive" id="otherPosts_table">
                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $item) { ?>
                                    <tr>
                                        ...
                                        <td><a href="edit-event.php?id=<?= $item['id']; ?>" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a></td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-danger delete_otherpost_btn" value="<?= $item['id']; ?>"><i class="fas fa-trash-alt"></i></button>
                                        </td>
                                    </tr>
                            <?php
                                }
