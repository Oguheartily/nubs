                ...
                ?>
                        ...
                        <div class="card col-12 shadow-sm mb-3 pt-1">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class=""><?= $postItem['heading']; ?></div>
                                    <div class="">
                                        <div>Category:
                                            <?php
                                        ...
                                        <span class="text-primary"><span class="fas fa-newspaper"></span></span>
                                        <span class="text-success"><span class="fa fa-calendar-alt"></span></span>
                                        <span class="text-danger"><span class="fas fa-bell"></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
